            ...
            children: [
              ...
              Obx(() {
                return AppButton(
                  ...
                  verticalMargin: 12,
                  backgroundColor: selectgenderforman.value ? AppColors.tealbackground : AppColors.tealbackground.withOpacity(0.3),
                );
              }),
              10.verticalSpace,
              Obx(() {
                return AppButton(
                  ...
                  verticalMargin: 12,
                  backgroundColor: selectgenderforwoamn.value ? AppColors.tealbackground : AppColors.tealbackground.withOpacity(0.3),
                );
              }),
              10.verticalSpace,
              Obx(() {
                return AppButton(
                  ...
                  verticalMargin: 12,
                  backgroundColor: selectgenderfortransgender.value ? AppColors.tealbackground : AppColors.tealbackground.withOpacity(0.3),
                );
              })
            ],
          ),
          ...
          child: BottomAppBar(
            ...
            child: Obx(() {
              return AppButton(
                ...
                horizontalMargin: 0,
                text: "Continue",
                backgroundColor: buttonbecomedark.value ? AppColors.buttoncolourforapp : AppColors.buttoncolourforapp.withOpacity(0.5),
              );
            }),
          ),
        ));
